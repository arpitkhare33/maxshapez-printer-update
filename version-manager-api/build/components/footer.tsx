      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Arpit Khare</h3>
            <p className="text-slate-300 mb-4 max-w-md">
              Full-Stack MERN Developer with expertise in Python, NLP, and cybersecurity. Experienced in building
              secure, scalable enterprise applications for Reliance Jio, with previous experience at AMD and IIT
              Roorkee.
            </p>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} Arpit Khare. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
